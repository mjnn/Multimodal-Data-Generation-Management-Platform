# oms-multimodal-sdk 0.3.0 发布包

## 包文件

| 文件 | 用途 |
|------|------|
| `oms_multimodal_sdk-0.3.0-py3-none-any.whl` | **推荐**：wheel，Python 3.10+ |
| `oms_multimodal_sdk-0.3.0.tar.gz` | 源码包 |
...
python -m build
Copy-Item dist/oms_multimodal_sdk-0.3.0-py3-none-any.whl .
```

产物：`dist/` 与仓库根 `oms_multimodal_sdk-0.3.0-py3-none-any.whl`。
